"""
Django settings for eat_wise project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-q*f9-m*tu!9r+mcvrz*8%_209x&s1z!m13lj)&bm29chmds)69')
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=1),  # Increased to reduce refresh requests
...
WSGI_APPLICATION = 'eat_wise.wsgi.application'
